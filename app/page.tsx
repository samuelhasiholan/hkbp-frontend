...
import { ArrowRight, CalendarDays, Church, Newspaper, UsersRound } from "lucide-react";
        ...
        <div className="relative mx-auto grid min-h-[calc(100vh-4.25rem)] max-w-7xl items-center gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
          ...
          <div className="rounded-md border border-white/15 bg-white/10 p-5 shadow-2xl backdrop-blur">
            <div className="grid gap-3">
              {[
                ["Ibadah Minggu", "Informasi jam ibadah dan petugas pelayanan."],
                ["Partangiangan", "Jadwal persekutuan doa wijk dan kategorial."],
                ["Pelayanan Khusus", "Baptis, sidi, pernikahan, dan penghiburan."],
              ].map(([title, body]) => (
                <div className="rounded-md bg-white p-4 text-slate-950" key={title}>
