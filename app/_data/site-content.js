...
exports.allPageSlugs = exports.pageContent = exports.SITE_NAME = void 0;
exports.SITE_NAME = "HKBP Resort Srengseng Sawah";
const createSectionProfiles = (sectionName) => Array.from({ length: 5 }, (_, index) => ({
    id: `${sectionName.toLowerCase().replaceAll(" ", "-")}-${index + 1}`,
    name: `Nama ${sectionName} ${index + 1}`,
    role: `Jabatan ${sectionName} ${index + 1}`,
}));
const retiredElderProfiles = Array.from({ length: 50 }, (_, index) => ({
...
exports.pageContent = {
    "tentang-gereja": {
        ...
        summary: "HKBP Resort Srengseng Sawah hadir sebagai rumah rohani yang menumbuhkan iman, persekutuan, kesaksian, dan pelayanan kasih bagi warga jemaat serta masyarakat sekitar.",
        highlights: ["Sejarah pelayanan", "Visi dan misi", "Dokumentasi kegiatan"],
        childPages: [
            {
                title: "Sejarah",
                description: "Telusuri perjalanan jemaat dari awal persekutuan hingga pelayanan yang berlangsung saat ini.",
                href: "/tentang-gereja/sejarah",
            },
            {
                title: "Visi & Misi",
                description: "Lihat arah pelayanan bersama yang menuntun pertumbuhan iman, persekutuan, dan kesaksian jemaat.",
                href: "/tentang-gereja/visi-misi",
            },
            {
                title: "Galeri",
                description: "Buka dokumentasi kegiatan ibadah, pelayanan kategorial, dan momen kebersamaan jemaat.",
    ...
    "tentang-gereja/sejarah": {
        ...
        description: "Catatan perjalanan jemaat dari awal persekutuan hingga pelayanan yang berlangsung saat ini.",
        summary: "Sejarah jemaat adalah kisah pertumbuhan iman bersama yang dapat terus dilengkapi melalui CMS sesuai arsip resmi gereja.",
        highlights: [
    ...
    "tentang-gereja/visi-misi": {
        ...
        eyebrow: "Tentang Gereja",
        layoutVariant: "article",
        description: "Arah bersama untuk menjadi jemaat yang bertumbuh, melayani, dan menjadi berkat.",
        summary: "Visi dan misi menjadi kompas pelayanan agar seluruh program gereja berjalan selaras dengan panggilan Kristus dan kebutuhan jemaat.",
        highlights: [
            "Iman yang bertumbuh",
        ...
        callout: "Rumusan ini dapat disesuaikan lagi dengan keputusan resmi majelis jemaat jika sudah tersedia.",
    },
    "tentang-gereja/galeri": {
        title: "Galeri",
        eyebrow: "Tentang Gereja",
        description: "Dokumentasi kegiatan ibadah, persekutuan, pelayanan sosial, dan momen khusus jemaat.",
        summary: "Galeri membantu jemaat menyimpan ingatan bersama dan memperlihatkan wajah pelayanan gereja kepada warga serta tamu yang baru mengenal jemaat.",
        highlights: [
            "Ibadah dan perayaan",
            "Kegiatan kategorial",
            "Pelayanan kasih",
        ...
        galleryImages: [
            ...
            },
            {
                ...
                description: "Kebersamaan warga jemaat dalam persekutuan dan kegiatan keluarga.",
            },
            {
                src: "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=1200&q=80",
                alt: "Kelompok pelayanan berkumpul bersama",
                description: "Kegiatan kategorial, pembinaan iman, dan pelayanan kunjungan.",
            },
            {
    ...
    organisasi: {
        ...
        description: "Struktur pelayan gereja yang mendukung ibadah, pembinaan, kesaksian, dan pelayanan kasih.",
        summary: "Organisasi jemaat menolong pelayanan berjalan tertib: pendeta, parhalado, fungsionaris, dewan, dan wijk bekerja bersama sesuai tugas masing-masing.",
        highlights: [
        ...
        childPages: [
            {
                title: "Pendeta",
                description: "Kenali para pelayan tertahbis yang memimpin penggembalaan, firman, dan sakramen.",
                href: "/organisasi/pendeta",
            },
            {
                title: "Fungsionaris",
                description: "Lihat pelayan yang mengelola administrasi, keuangan, dan koordinasi kegiatan jemaat.",
                href: "/organisasi/fungsionaris",
            },
            {
                title: "Dewan Koinonia",
                description: "Masuk ke bidang persekutuan, pembinaan iman, dan pelayanan kategorial jemaat.",
                href: "/organisasi/dewan-koinonia",
            },
            {
                title: "Dewan Marturia",
                description: "Telusuri bidang kesaksian, publikasi, musik, dan pewartaan kabar baik.",
                href: "/organisasi/dewan-marturia",
            },
            {
                title: "Dewan Diakonia",
                description: "Buka bidang pelayanan kasih, kepedulian sosial, dan pendampingan warga jemaat.",
                href: "/organisasi/dewan-diakonia",
            },
            {
                title: "Wilayah (Wijk)",
                description: "Lihat pembagian wilayah pelayanan yang mempererat perhatian antar keluarga jemaat.",
                href: "/organisasi/wilayah-wijk",
            },
            {
                title: "Sintua Purnabakti",
                description: "Temukan arsip penghormatan bagi para sintua yang pernah melayani jemaat.",
    ...
    "organisasi/pendeta": {
        ...
        description: "Pelayan tertahbis yang memimpin penggembalaan, pemberitaan firman, dan pelayanan sakramen.",
        summary: "Pendeta menjadi gembala jemaat yang mengarahkan pelayanan rohani, mendampingi warga jemaat, serta menjaga kehidupan gereja tetap setia pada firman Tuhan.",
    ...
    "organisasi/fungsionaris": {
        ...
        description: "Pelayan yang membantu pengelolaan administrasi, keuangan, dan koordinasi kegiatan jemaat.",
        summary: "Fungsionaris menjaga roda organisasi berjalan rapi agar pelayanan gereja dapat dilaksanakan dengan transparan, terencana, dan bertanggung jawab.",
    ...
    "organisasi/dewan-koinonia": {
        ...
        description: "Bidang yang memperkuat persekutuan, pembinaan iman, dan kehidupan kategorial jemaat.",
        summary: "Dewan Koinonia menolong jemaat bertumbuh dalam persekutuan yang hangat, pembinaan yang terarah, dan relasi yang saling membangun.",
        ...
        councilSections: [
            {
                ...
                description: "Seksi Sekolah Minggu mendampingi pelayanan anak melalui pembinaan iman, ibadah anak, dan kegiatan yang menolong anak mengenal firman Tuhan sejak dini.",
                profiles: createSectionProfiles("Seksi Sekolah Minggu"),
            },
            {
                id: "seksi-remaja",
                title: "Seksi Remaja",
                description: "Seksi Remaja mengembangkan pembinaan iman dan persekutuan remaja agar bertumbuh dalam karakter, relasi yang sehat, dan keterlibatan pelayanan gereja.",
                profiles: createSectionProfiles("Seksi Remaja"),
            },
            {
                id: "seksi-naposobulung",
                title: "Seksi Naposobulung",
                description: "Seksi Naposobulung menjadi ruang pelayanan pemuda untuk bertumbuh dalam iman, kepemimpinan, kreativitas, dan kesaksian di tengah jemaat.",
                profiles: createSectionProfiles("Seksi Naposobulung"),
            },
            {
                id: "seksi-parompuan",
                title: "Seksi Parompuan",
                description: "Seksi Parompuan memperkuat pelayanan perempuan melalui persekutuan, pembinaan keluarga, pelayanan kasih, dan dukungan aktif dalam kehidupan jemaat.",
                profiles: createSectionProfiles("Seksi Parompuan"),
            },
            {
                id: "seksi-ama",
                title: "Seksi Ama",
                description: "Seksi Ama menggerakkan pelayanan kaum bapak dalam pembinaan iman, teladan keluarga, persekutuan, dan keterlibatan dalam program gereja.",
                profiles: createSectionProfiles("Seksi Ama"),
            },
            {
                id: "seksi-lansia",
                title: "Seksi Lansia",
                description: "Seksi Lansia memperhatikan warga lanjut usia melalui persekutuan, kunjungan, pendampingan rohani, dan kegiatan yang membangun sukacita bersama.",
    ...
    "organisasi/dewan-marturia": {
        ...
        eyebrow: "Organisasi",
        layoutVariant: "council",
        description: "Bidang kesaksian gereja melalui pekabaran Injil, komunikasi, dan keterlibatan publik.",
        summary: "Dewan Marturia mengajak jemaat menyatakan kabar baik melalui kesaksian hidup, pelayanan komunikasi, dan kegiatan yang menjangkau masyarakat.",
        ...
        councilSections: [
            {
                id: "seksi-zending",
                title: "Seksi Zending",
                description: "Seksi Zending menggerakkan semangat pekabaran Injil, kepedulian misi, dan dukungan jemaat untuk pelayanan kesaksian di dalam maupun di luar lingkungan gereja.",
                profiles: createSectionProfiles("Seksi Zending"),
            },
            {
                id: "seksi-musik",
                title: "Seksi Musik",
                description: "Seksi Musik mendukung pelayanan pujian melalui pembinaan pemusik, song leader, koor, dan tata pelayanan musik yang menolong jemaat beribadah.",
    ...
    "organisasi/dewan-diakonia": {
        ...
        eyebrow: "Organisasi",
        layoutVariant: "council",
        description: "Bidang pelayanan kasih untuk warga jemaat dan masyarakat yang membutuhkan perhatian.",
        summary: "Dewan Diakonia mengelola pelayanan kasih agar gereja hadir secara nyata bagi yang sakit, berduka, berkekurangan, atau membutuhkan pendampingan.",
        ...
        councilSections: [
            {
                ...
                description: "Seksi Diakoni Sosial mengoordinasikan pelayanan kasih bagi warga jemaat dan masyarakat yang membutuhkan perhatian, dukungan, dan pendampingan.",
                profiles: createSectionProfiles("Seksi Diakoni Sosial"),
            },
            {
                id: "seksi-pendidikan",
                title: "Seksi Pendidikan",
                description: "Seksi Pendidikan memperhatikan dukungan pendidikan, pembinaan belajar, dan program yang menolong warga jemaat bertumbuh dalam pengetahuan dan karakter.",
                profiles: createSectionProfiles("Seksi Pendidikan"),
            },
            {
                id: "seksi-kesehatan",
                title: "Seksi Kesehatan",
                description: "Seksi Kesehatan mendukung pelayanan kesehatan jemaat melalui edukasi, perhatian kepada yang sakit, dan kegiatan promotif yang membangun kepedulian.",
                profiles: createSectionProfiles("Seksi Kesehatan"),
            },
            {
                id: "seksi-kemasyarakatan",
                title: "Seksi Kemasyarakatan",
                description: "Seksi Kemasyarakatan menjembatani kepedulian gereja dengan lingkungan sekitar melalui kerja sama sosial, komunikasi, dan pelayanan masyarakat.",
    ...
    "organisasi/wilayah-wijk": {
        ...
        eyebrow: "Organisasi",
        layoutVariant: "wijk",
        description: "Ruang pelayanan terdekat bagi keluarga jemaat untuk bertumbuh dalam persekutuan, perhatian, dan komunikasi yang hangat.",
        summary: "Setiap wijk menjadi lingkar pelayanan yang menolong gereja hadir lebih dekat di tengah kehidupan keluarga jemaat.",
        highlights: [
    ...
    "organisasi/sintua-purnabakti": {
        title: "Sintua Purnabakti",
        eyebrow: "Organisasi",
        description: "Ruang penghormatan bagi para sintua purnabakti yang telah melayani jemaat dalam masa tugasnya.",
        summary: "Sintua purnabakti adalah bagian penting dari perjalanan pelayanan gereja. Halaman ini memuat dokumentasi foto, nama, jabatan, masa tugas, dan kisah pelayanan singkat.",
    ...
    "jadwal-pelayanan": {
        ...
        description: "Informasi jadwal ibadah, partangiangan, dan pelayanan khusus jemaat.",
        summary: "Jadwal pelayanan membantu jemaat menyiapkan diri untuk beribadah, melayani, dan hadir dalam kegiatan persekutuan dengan tertib.",
        highlights: ["Ibadah Minggu", "Partangiangan", "Pelayanan khusus"],
        childPages: [
            {
                title: "Ibadah Minggu",
                description: "Lihat jadwal ibadah Minggu, jam kebaktian, dan informasi susunan pelayanan utama.",
                href: "/jadwal-pelayanan/ibadah-minggu",
            },
            {
                title: "Partangiangan",
                description: "Buka jadwal persekutuan doa di wijk, rumah keluarga, dan kelompok kategorial.",
                href: "/jadwal-pelayanan/partangiangan",
            },
            {
                title: "Pelayanan Khusus",
                description: "Temukan informasi pelayanan baptis, sidi, pernikahan, penghiburan, dan pastoral.",
    ...
    "jadwal-pelayanan/ibadah-minggu": {
        ...
        summary: "Ibadah Minggu menjadi pusat persekutuan jemaat untuk mendengar firman Tuhan, memuji, berdoa, dan mempersembahkan hidup bagi kemuliaan Allah.",
        highlights: [
    ...
    "jadwal-pelayanan/partangiangan": {
        ...
        eyebrow: "Jadwal Pelayanan",
        layoutVariant: "article",
        description: "Jadwal persekutuan doa di rumah keluarga, wijk, dan kelompok kategorial.",
        summary: "Partangiangan mempererat persekutuan keluarga jemaat melalui doa, nyanyian, pembacaan firman, dan saling menguatkan.",
        highlights: [
    ...
    "jadwal-pelayanan/pelayanan-khusus": {
        ...
        eyebrow: "Jadwal Pelayanan",
        layoutVariant: "article",
        description: "Informasi pelayanan baptis, sidi, pernikahan, penghiburan, dan kegiatan gerejawi khusus.",
        summary: "Pelayanan khusus membantu jemaat melewati momen penting kehidupan dengan pendampingan firman, doa, dan tata pelayanan gereja.",
        highlights: [
    ...
    "warta-jemaat": {
        ...
        description: "Pengumuman ibadah, agenda, persembahan, dan berita pelayanan jemaat.",
        summary: "Warta jemaat menjadi kanal informasi resmi agar warga mengetahui agenda pelayanan, pokok doa, kegiatan, dan keputusan penting gereja.",
        highlights: ["Warta mingguan", "Pengumuman", "Arsip"],
        childPages: [
            {
                title: "Warta Mingguan",
                description: "Buka warta terbaru untuk ibadah dan kegiatan minggu berjalan.",
                href: "/warta-jemaat/warta-mingguan",
            },
            {
                title: "Arsip Warta",
                description: "Cari kumpulan warta terdahulu sebagai dokumentasi dan rujukan pelayanan.",
    ...
    "warta-jemaat/warta-mingguan": {
        ...
        description: "Warta minggu ini terbuka otomatis dalam PDF viewer, lengkap dengan tombol unduh dan share untuk memudahkan distribusi kepada jemaat.",
        summary: "Halaman ini disiapkan untuk menampilkan warta terbaru, baik sebagai ringkasan web maupun tautan unduhan PDF resmi gereja dalam Bahasa Indonesia dan Bahasa Batak.",
    ...
    "warta-jemaat/arsip-warta": {
        title: "Arsip Warta",
        eyebrow: "Warta Jemaat",
        description: "Beberapa sample warta minggu yang sudah berlalu. Pilih salah satu arsip untuk langsung menampilkan PDF viewer di halaman ini.",
        summary: "Arsip warta membantu gereja menyimpan jejak pelayanan, pengumuman, dan kegiatan dari waktu ke waktu secara mudah dicari.",
        highlights: [
    ...
    "berita-publikasi": {
        ...
        description: "Kumpulan berita kegiatan, artikel renungan, dan publikasi resmi untuk mendukung kehidupan persekutuan jemaat.",
        summary: "Setiap section berisi sample thumbnail yang dapat dibuka ke halaman detail, lengkap dengan fitur berbagi ke media sosial dan salin tautan.",
        highlights: [
            "Berita kegiatan",
    ...
    kontak: {
        ...
        description: "Informasi alamat, kanal komunikasi, dan waktu pelayanan kantor gereja.",
        summary: "Warga jemaat dan pengunjung dapat menghubungi gereja untuk kebutuhan informasi ibadah, pelayanan pastoral, administrasi, dan kegiatan jemaat.",
        ...
        mapEmbedUrl: "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.3854148016317!2d106.82937057509652!3d-6.3441070936456985!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69ec3230939161%3A0xb778022ec0c0afde!2sHKBP%20Srengseng%20Sawah%20Lutheran%20Church!5e0!3m2!1sen!2sid!4v1781768122519!5m2!1sen!2sid",
    },
};
exports.allPageSlugs = Object.keys(exports.pageContent).filter((slug) => ![
    "warta-jemaat/warta-mingguan",
    "warta-jemaat/arsip-warta",
    "berita-publikasi",
].includes(slug));
